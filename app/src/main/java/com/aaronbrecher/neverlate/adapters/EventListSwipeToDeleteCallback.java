...
public class EventListSwipeToDeleteCallback extends ItemTouchHelper.SimpleCallback {
    private EventListAdapter mAdapter;
    private Drawable icon;
    private final ColorDrawable background;
    private SwipeToDeleteListener mListener;

    public EventListSwipeToDeleteCallback(EventListAdapter adapter, SwipeToDeleteListener listener) {
